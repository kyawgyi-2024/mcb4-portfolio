...
window.addEventListener("scroll", function () {
  ...
  if (scrollY > 100) {
    header.style.background =
      "linear-gradient(135deg, rgba(26, 54, 93, 0.95), rgba(45, 55, 72, 0.95))";
...
document
  .querySelectorAll(".team-member, .service-card, .about-text, .contact-info")
  .forEach((el) => {
    el.style.opacity = "0";
    observer.observe(el);
  });
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("DevOps02 Portfolio Website Loaded Successfully!");
